...
<body>
        ...
        <?php
          ...
          <form id="alarmbox" class="dashboardbox"  name="alarm" method="post" accept-charset="utf-8">
        <div>Alarm</div>
       <div class="hr"><hr /></div>
        <table id="housealarm">
          <tr>
            ...
            <td>
             <label class="switch">
                <input type="checkbox" id="alarmstatus" name="alarmstatus" <?php if ($status == 1) echo 'checked'; ?>>
